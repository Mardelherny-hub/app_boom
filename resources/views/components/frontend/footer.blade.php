        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div class="col-span-1 md:col-span-2">
                ...
                <p class="text-sm text-gray-400 mb-4">
                    Modern web agency starter kit built with Laravel. 
                    Professional, scalable, and ready for your next project.
                </p>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-2">
                    ...
                    <li><a href="{{ route('services.index') }}" class="text-sm hover:text-white transition">Services</a></li>
                    <li><a href="{{ route('portfolio.index') }}" class="text-sm hover:text-white transition">Portfolio</a></li>
                    <li><a href="{{ route('blog.index') }}" class="text-sm hover:text-white transition">Blog</a></li>
