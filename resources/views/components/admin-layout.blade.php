            ...
            <div class="flex flex-col w-64 bg-gray-900">
                ...
                <div class="flex-shrink-0 flex border-t border-gray-800 p-4">
                    <div class="flex items-center w-full">
                        ...
                        <form method="POST" action="/logout" id="logout-form" class="ml-3">
                            @csrf
                            <button type="button" onclick="document.getElementById('logout-form').submit()" class="text-gray-400 hover:text-white transition">
